...
Besides detecting errors, you can explicitly send logs to the Steroids Connect window with `steroids.logger.log("Your message here!")`, which can be extremely useful for tracking your application state when debugging. To read more about logging, head over to the [Logging guide][logging-guide].
...
Save both files and you'll see that after you take a picture, it is displayed in the camera view. To read more about them and other device APIs, see the [device API reference][device-api].
</section>
...
[debug-ios]: /steroids/debugging/debugging-on-ios
[debug-android]: /steroids/debugging/debugging-on-android
[debug-best-practices]: /steroids/debugging/best-practices
[device-api]: /supersonic/api-reference/stable
[logging-guide]: /steroids/debugging/logging
[native-styles]: /supersonic/guides/ui/styling-native-components
[ss-structure]: /supersonic/guides/
